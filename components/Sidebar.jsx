...
export default function Sidebar({ component }) {
    ...
    const { isAuthenticated, username, setUsername, nickname, setNickname, handleUsername } = useContext(AmazonContext);
                    ...
                    <>
                        ...
                        {!username ? (
                            <>
                                ...
                                <button className={styles.setNickname} onClick={handleUsername}>
                                    Set Nickname
                                </button>
                            </>
                        ) : (
            ...
            <div className={styles.menu}>
                <Link href="/">
                    <div className={styles.menuItem}>
                        <Image src={logo} height={30} width={30} className={styles.amazoneLog} />
                        My Amazon <br /> borad
                    </div>
                </Link>
                <div className={styles.menuItem}>
