...
const BuyModal = ({ close, buyTokens }) => {
    ...
    const { amountDue, setAmountDue, tokenAmount, setTokenAmount, isLoading, setIsLoading, etherscanLink, setEtherscanLink } =
        ...
        <div className={styles.container}>
            {isLoading ? (
                ...
                <>
                    ...
                    <div className={styles.price}>Total Due: {tokenAmount && tokenAmount > 0 ? amountDue + 'ETH' : '0 ETH'}</div>
                    <button
                    ...
                    {etherscanLink && (
                        <>
                            <div className={styles.success}>Transaction Sucessful! Check out your receipt for your transaction below!</div>
